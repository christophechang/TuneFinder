...
def _track_row(
    ...
    reason = html.escape(compose_reason(c, profiles_lower, label_artists=label_artists, today=today))
    ...
    for section_key in _SECTION_ORDER:
        ...
        if section_key == "label_watch":
            ...
            for c in group_candidates:
                n = pos_map[id(c)]
                lines.append(_track_row(n, c, profiles_lower, label_artists, mark_by_number, today))
        else:
